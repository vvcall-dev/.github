...
|------ |---------------------------------------|--------------------------------------------------|
|client |Desktop native client (Windows/Linux)  |[✅ Active](https://github.com/vvcall-dev/client) |
|server |WebSocket signaling server (Docker)    |[✅ Active](https://github.com/vvcall-dev/server) |
